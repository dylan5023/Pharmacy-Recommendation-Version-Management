...
class DirectionServiceTest extends Specification {
    ...
    def "buildDirectionList - Check whether the result values are sorted by distance"() {
        given:
    ...
    def "buildDirectionList - Check if search is possible within a specified radius of 10 km"(){
